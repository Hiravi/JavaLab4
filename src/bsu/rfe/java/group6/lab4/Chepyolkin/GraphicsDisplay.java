package bsu.rfe.java.group6.lab4.Chepyolkin;
...
public class GraphicsDisplay extends JPanel {
    ...
    protected void paintMarkers(Graphics2D canvas) {
        ...
        for (Double[] point : graphicsData) {
            ...
            if (isOdd(point[1]) )
            {
                canvas.setColor(Color.GREEN);			//иначе - синий
            }
            path.append(new Line2D.Double(center.getX() + 10.0, center.getY() - 0.0, center.getX() + 0.0, center.getY() + 10.0), false);
            path.append(new Line2D.Double(center.getX() + 0.0, center.getY() + 10.0, center.getX() - 10.0, center.getY() - 0.0), false);
            path.append(new Line2D.Double(center.getX() - 10.0, center.getY() - 0.0, center.getX() + 0.0, center.getY() - 10.0), false);
            path.append(new Line2D.Double(center.getX() + 0.0, center.getY() - 10.0, center.getX() + 10.0, center.getY() + 0.0), false);
            canvas.draw(path);
        }
    ...
    //Целая часть значения функции в точке - нечѐтная
